...
function UserInput({ activity, setActivity }: ActivityProps) {
  ...
  return (
    <div
      className="
        w-full mt-6 px-6 pt-4 rounded-xl
        bg-white dark:bg-slate-800
        border border-slate-200 dark:border-slate-700
        shadow-sm dark:shadow-none
      "
    >
      <div className="text-2xl text-center mb-6 font-semibold text-slate-800 dark:text-slate-100">
        <h2>Add Activity</h2>
      </div>
      ...
      <form onSubmit={submitHandler} className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3 items-center">
          <label className="text-slate-600 dark:text-slate-300">Duration</label>
          <div className="flex gap-4">
            <input
              type="number"
              placeholder="hr"
              className="
                w-16 rounded-md p-2 text-center
                bg-slate-50 dark:bg-slate-900
                border border-slate-300 dark:border-slate-600
                text-slate-800 dark:text-slate-100
                focus:outline-none focus:ring-2 focus:ring-amber-400
